...
{
    /** @test */
    function it_generates_template_send_bill_async() {
    ...
    /** @test */
    function it_generates_template_send_test_set_async() {
        $pathCertificate = dirname(dirname(__FILE__)).'/certicamara.p12';
        $passwors = '3T3rN4661343';
    ...
    /** @test */
    function it_generates_template_get_status_zip() {
        $pathCertificate = dirname(dirname(__FILE__)).'/certicamara.p12';
        $passwors = '3T3rN4661343';
    ...
    /** @test */
    function it_generates_template_get_status() {
        $pathCertificate = dirname(dirname(__FILE__)).'/certicamara.p12';
        $passwors = '3T3rN4661343';
